...
public class PandaController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        print("Testing log cat");
        print(articulationChain.Length);
        Debug.Log("efwwef");
        foreach (ArticulationBody joint in articulationChain)
        {
            Debug.Log("Name is: "+ joint.gameObject.name);
    ...
    private void UpdateDirection(int jointIndex)
    {
        ...
        JointController current = articulationChain[jointIndex].GetComponent<JointController>();
        if (previousIndex != jointIndex)
        {
            JointController previous = articulationChain[previousIndex].GetComponent<JointController>();
